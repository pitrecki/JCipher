...
/**
 * Ciphers are arguably the corner stone of cryptography. In general, a org.pitrecki.cipher is
 ...
 * a javascript implementation for each org.pitrecki.cipher that allows encryption and decryption of abitrary
 * text (of your choosing) using the org.pitrecki.cipher. Some history of each org.pitrecki.cipher is also included,
