 ...
 * claim they're not familiar with "cryptography", they are often familiar with the concept
 * of ciphers, whether or not they are actually conscious of it. Recent films such as
 * "The Da Vinci Code" and "National Treasure: Book of Secrets" have plots centered around
...
//                .collect(Collectors.toList());
    ...
    public String toString() {
        ...
        return "DECODED/ENCODED TEXT: " + getProcessedText() +
                "\nENCRYPT MATRIX:\n" + strEncryptMatrix +
