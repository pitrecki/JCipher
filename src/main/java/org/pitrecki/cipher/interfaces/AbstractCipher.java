...
public interface AbstractCipher
{
     ...
     *  plaintext. A org.pitrecki.cipher (or cypher) is a pair of algorithms that create the encryption and the
     *  reversing decryption. The detailed operation of a org.pitrecki.cipher is controlled both by the algorithm
