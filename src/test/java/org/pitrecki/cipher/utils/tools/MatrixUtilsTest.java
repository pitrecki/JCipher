...
class MatrixUtilsTest
{
    ...
    @Test
    @DisplayName("Test get row on matrix with specified column should return column vector")
    void testGetRowShouldReturnVector() {
        matrixUtils = new MatrixUtils<>(data);

        Integer[][] actual = matrixUtils.getColumn(2);
    ...
    @Test
    @DisplayName("Test get column matrxi should return column based matrix")
